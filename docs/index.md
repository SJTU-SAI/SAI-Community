...
-   :fontawesome-solid-school:{ .lg .middle } __Courses in SJTU__

    ---

    有关培养计划内课程的评价

    [:octicons-arrow-right-24: Courses Information](./courses/init.md)

-   :fontawesome-solid-map-location-dot:{ .lg .middle } __Roadmap for Developers__
...
-   :fontawesome-solid-handshake-angle:{ .lg .middle } __Contributions__
    ...
    像成为本仓库的贡献者？这里有你需要的一切

    [:octicons-arrow-right-24: Contributions](./contributions/contributors.md)

-   :fontawesome-solid-calendar-days:{ .lg .middle } __More is coming...__

    ---

    More is coming... Just enjoy and wait!
